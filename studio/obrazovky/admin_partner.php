...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['uloz_poznamku'])) { $pp['poznamka_admin'] = mb_substr((string)$_POST['poznamka'], 0, 1000); nj_partner_uloz($pp); nj_sprava('Poznámka uložená.'); }
...
<label>Poznámka admina <textarea name="poznamka" rows="2"><?= h($pp['poznamka_admin']) ?></textarea> <button class="btn mini" name="uloz_poznamku" value="1">Uložiť poznámku</button></label>
</form>
